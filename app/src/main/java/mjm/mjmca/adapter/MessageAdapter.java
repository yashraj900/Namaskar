...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public MessageAdapter(Context context, List<ChatMessages> chatMessages) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == MESSAGE_RIGHT){
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.receiverchats, parent, false);
            return new ViewHolder(view);
        }
    }
    @Override
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final ChatMessages cm = chatMessages.get(position);
                ...
                public boolean onLongClick(View view) {
                    ...
                    builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            reference.child("Chat").child(cm.getMessagePushID()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        public TextView chat_message, fileExtension, audio_name;
