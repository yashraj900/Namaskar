...
public class AddParticipantsAdapter extends RecyclerView.Adapter<AddParticipantsAdapter.ViewHolder> {
    ...
    public AddParticipantsAdapter(Context context, ArrayList<Contact> contactArrayList, String groupID, String groupRole) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.add_participants, parent, false);
